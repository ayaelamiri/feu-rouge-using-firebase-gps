...
#define FIREBASE_HOST "leds-f5829-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "6zilH2j9iud2oUpRql1PaXkLHQfBpzKSMvaiR8wP"

//Replace with your network credentials
const char* ssid     = "AndroidZineb";
const char* password = "gupn23921";
...
if (Firebase.failed()) {
  ...
  if (buttonState==HIGH) {              // Si la variable “butonstate” est fermé
